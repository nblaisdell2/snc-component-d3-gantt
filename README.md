# D3 Gantt Chart — UI Builder custom component

A configurable D3 chart for ServiceNow UI Builder.

- **Component tag:** `x-1295779-gantt-chart-uic`
- **Scope:** `x_1295779_gantt_0`
...
(`src/x-1295779-gantt-chart-uic/chart.js`), then document the properties and events here.
